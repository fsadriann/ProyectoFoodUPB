...
/**
 * Modelo de cuadrante geográfico del sistema Food UPB.
 *
 * <p>Un cuadrante representa una zona de entrega en la ciudad.
 * El campo {@link #nombre} es el identificador único y la clave
 * que se usa como vértice en el grafo de rutas ({@code matrixGraph<String>}).
 *
 * <p><b>Para visualización futura (Swing):</b> los campos {@link #latitud}
 * y {@link #longitud} permiten posicionar el cuadrante en un mapa sin
 * rediseñar el modelo.
 *
 * <p><b>Para logística de entregas:</b> {@link #disponible} permite activar
 * o desactivar un cuadrante sin eliminarlo del grafo, de modo que RF de
 * entregas pueda filtrar destinos operativos sin cambiar la estructura.
 *
 * @author fsadriann
 */
