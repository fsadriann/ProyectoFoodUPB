...
class OrderServiceTest {
    ...
    private edu.fsadriann.server.model.cuadrante.CuadranteService mapaBasico() {
        edu.fsadriann.server.model.cuadrante.CuadranteService cs =
                new edu.fsadriann.server.model.cuadrante.CuadranteService();
        cs.agregarCuadrante(new edu.fsadriann.server.model.cuadrante.Cuadrante("UPB",      "Campus UPB"));
        cs.agregarCuadrante(new edu.fsadriann.server.model.cuadrante.Cuadrante("Cabecera", "Barrio Cabecera"));
        cs.agregarCuadrante(new edu.fsadriann.server.model.cuadrante.Cuadrante("Laureles", "Barrio Laureles"));
    ...
    void ruta_origenBaseNoExiste_retornaNull() throws RemoteException {
        // Grafo sin UPB
        edu.fsadriann.server.model.cuadrante.CuadranteService csSinBase =
                new edu.fsadriann.server.model.cuadrante.CuadranteService();
        csSinBase.agregarCuadrante(
                new edu.fsadriann.server.model.cuadrante.Cuadrante("Cabecera", "Zona"));
